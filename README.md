...
* Download the collection: [stable](https://github.com/set-soft/collection-kefir_i/archive/v0.3.0.zip) or [development](https://github.com/set-soft/collection-kefir_i/archive/master.zip)
...
* *Varios*
  ...
  * *Registros*
    ...
    * *Universal Complete* (3/4/8/9/10/16/32)
    * *Universal Simple* (3/4/8/16/32)
    * *Shift Right Complete* (3/4/8/10/16/32)
    * *Shift Right ENA+RST* (3/4/8/9/16/32)
