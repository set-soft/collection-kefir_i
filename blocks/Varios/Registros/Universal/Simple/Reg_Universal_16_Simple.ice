{
  "version": "1.1",
  "package": {
    "name": "Universal Shift Register 16 bits (Simple)",
    "version": "1.0.0",
    "description": "Registro de desplazamiento universal de 16 bits con enable, carga paralela y desplazamiento bidireccional",
