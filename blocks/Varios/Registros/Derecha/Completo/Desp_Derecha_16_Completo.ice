{
  "version": "1.1",
  "package": {
    "name": "Shift Right Register 16 bits",
    "version": "1.0.0",
    "description": "Registro de desplazamiento a derecha de 16 bits con reset, enable y carga paralela",
    "author": "Salvador E. Tropea",
    "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20height=%2214.734%22%20width=%2215.466%22%20viewBox=%220%200%2014.49939%2013.8132%22%3E%3Ctext%20font-size=%2230.55%22%20y=%2215.857%22%20x=%22-2.879%22%20font-family=%22sans-serif%22%20letter-spacing=%220%22%20word-spacing=%220%22%3E%3Ctspan%20font-weight=%22bold%22%20y=%2215.857%22%20x=%22-2.879%22%20fill=%22green%22%3E%C2%BB%3C/tspan%3E%3C/text%3E%3C/svg%3E"
  },
  "design": {
    "board": "kefir",
    "graph": {
      "blocks": [
        ...
        {
          "id": "1e80efcc-dfd9-4f98-848c-0ac6dbe5b49e",
          "type": "basic.input",
          "data": {
            "name": "rst",
            "pins": [
        ...
        {
          "id": "dd3960a6-2785-495d-9206-7422d6062456",
          "type": "basic.input",
          "data": {
            "name": "ena",
            "pins": [
        ...
        {
          "id": "bf0aca24-bdb2-4ac2-b3e7-d19a48c2e30d",
          "type": "basic.input",
          "data": {
            "name": "load",
            "pins": [
        ...
        {
          "id": "650fb227-f385-4602-886d-3bda5299dc33",
          "type": "basic.input",
          "data": {
            "name": "d",
            "range": "[15:0]",
        ...
        },
        {
          ...
          "type": "e528f5a6da94b230cbaabcc85fa21b29b861acd1",
          "position": {
            "x": 360,
            "y": 152
          },
      ...
      "wires": [
        {
          "source": {
            "block": "bf0aca24-bdb2-4ac2-b3e7-d19a48c2e30d",
            "port": "out"
          },
          "target": {
        ...
        {
          "source": {
            "block": "650fb227-f385-4602-886d-3bda5299dc33",
            "port": "out"
          },
          "target": {
            "block": "6c58b0e2-926d-4c62-96c2-3b3c97033026",
        ...
        {
          "source": {
            "block": "dd3960a6-2785-495d-9206-7422d6062456",
            "port": "out"
          },
          "target": {
            "block": "6c58b0e2-926d-4c62-96c2-3b3c97033026",
        ...
        {
          "source": {
            "block": "1e80efcc-dfd9-4f98-848c-0ac6dbe5b49e",
            "port": "out"
          },
          "target": {
            "block": "6c58b0e2-926d-4c62-96c2-3b3c97033026",
  ...
  "dependencies": {
    "e528f5a6da94b230cbaabcc85fa21b29b861acd1": {
      "package": {
        "name": "Universal Shift Register 16 bits",
        "version": "1.0.0",
        "description": "Registro de desplazamiento universal de 16 bits con reset, enable, carga paralela y desplazamiento bidireccional",
        "author": "Salvador E. Tropea",
