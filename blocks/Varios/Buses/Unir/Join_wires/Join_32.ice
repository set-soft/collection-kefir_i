{
  ...
  "package": {
    "name": "Join (wires -> 32)",
    "version": "0.0.1",
    "description": "Agregador de 32 bits a 1 bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
{ "id": "63c7309a-4460-4727-99ac-8c08c900502a-31",
"type": "basic.input",
"data": {
"name": "i31",
"pins": [
...
,
{ "id": "63c7309a-4460-4727-99ac-8c08c900502a-30",
"type": "basic.input",
"data": {
"name": "i30",
"pins": [
...
,
{ "id": "63c7309a-4460-4727-99ac-8c08c900502a-29",
"type": "basic.input",
"data": {
"name": "i29",
"pins": [
...

{
 ...
 "value": "0"
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "assign o={i31,i30,i29,i28,i27,i26,i25,i24,i23,i22,i21,i20,i19,i18,i17,i16,i15,i14,i13,i12,i11,i10,i9,i8,i7,i6,i5,i4,i3,i2,i1,i0};\n",
            "params": [],
            "ports": {
              "in": [
                { "name": "i31"
...
{ "name": "i0"
      ...
      "wires": [
        ...
        { "source": { "block": "63c7309a-4460-4727-99ac-8c08c900502a-31", "port": "out" },
  "target": { "block": "3545528c-05e2-4e95-8223-5b7b77587423", "port": "i31" }
}
,
{ "source": { "block": "63c7309a-4460-4727-99ac-8c08c900502a-30", "port": "out" },
  "target": { "block": "3545528c-05e2-4e95-8223-5b7b77587423", "port": "i30" }
}
,
{ "source": { "block": "63c7309a-4460-4727-99ac-8c08c900502a-29", "port": "out" },
  "target": { "block": "3545528c-05e2-4e95-8223-5b7b77587423", "port": "i29" }
}
,
