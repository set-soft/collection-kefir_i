{
  "version": "1.1",
  "package": {
    "name": "Split 4 (32 -> 8/8/8/8)",
    "version": "0.0.1",
    "description": "Separador de 1 bus de 32 bits a 4 buses de 8/8/8/8 bits",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "841486da-c923-436e-8fa4-1d24b4a7956d",
          "type": "basic.output",
          "data": {
            "name": "o3"
            ,"range": "[7:0]",
...

{
 ...
 "value": "0"
        ...
        {
          "id": "d9712c67-35f8-4019-935d-fa5ac82c4569",
          "type": "basic.output",
          "data": {
            "name": "o0"
            ,"range": "[7:0]",
 ...
 "value": "0"
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "d9712c67-35f8-4019-935d-fa5ac82c4569",
            "port": "in"
          }
          ,"size": 8
        },
        {
          ...
          "target": {
            "block": "841486da-c923-436e-8fa4-1d24b4a7956d",
            "port": "in"
          }
          ,"size": 8
        }
