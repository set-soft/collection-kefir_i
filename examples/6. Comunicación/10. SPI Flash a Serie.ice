  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "df91867c-36ec-4069-9eb7-887f528275ff",
        ...
        {
          "id": "30107466-73bf-4bdc-9da8-03b08e90e6bc",
          "type": "0c047e376a948cb9d8ae3766115c9627fe5819ce",
          "position": {
            "x": 600,
            "y": -32
          },
        ...
        {
          "id": "834fd173-3dda-466e-b5e2-246259da8453",
        ...
        {
          "id": "c02ed5dc-09ca-470d-b4d8-50e5bf670ab8",
        ...
        {
          "id": "4111374b-f128-49cd-a08e-f0c37aa7c3d1",
          "type": "c49282f2f18dab416a414d2d04c917f6935188aa",
          "position": {
            "x": 856,
            "y": -88
          },
        ...
        {
          "id": "90edfc06-021a-4b33-b636-366184e94d2e",
        ...
        {
          "id": "40f3849a-cc70-4a3b-8387-49f27a7a3b9d",
          "type": "0a71a1b7b26b058c7137ae1baeba7bc3b536eaaf",
          "position": {
            "x": 1176,
            "y": -136
        ...
        {
          "id": "d075ac4a-de3c-4fef-aab2-9b8b2d715db9",
          "type": "basic.info",
          "data": {
            "info": "Este bloque es una especie de puente entre el RS-232 y la memoria flash de configuración de la placa (W25X40CL)\nLa línea RTS funciona como \"Slave Select\", hay que tener en cuenta que el esclavo se selecciona llevándola a 0 y que el FT2232 la niega.\nPor lo que si desde la PC llevamos RTS a 1 la memoria queda seleccionada y el LED1 se apaga.\nUna vez seleccionada la memoria cada dato que enviemos será enviado a la memoria SPI, y su contestación enviada a la PC",
            "readonly": true
          },
          "position": {
            "x": 144,
        ...
        {
          "id": "1f95c4cb-e4d6-434c-9a0f-5ccc3742e3d7",
          "type": "9ba1be66568ffe4d9ccac0781a247ca51ed4fff6",
          "position": {
            "x": 1016,
            "y": -120
          },
        ...
        {
          "id": "d8a38bed-4655-4b86-877e-fa1b13b808f7",
          "type": "basic.info",
          "data": {
            "info": "<h1>Como probarlo</h1>\n<ol>\n<li>Ingresamos al <b>ScriptCommunicator</b></li>\n<li>Tildamos <b>RTS</b>, el LED1 se apaga</li>\n<li>Enviamos <b>AB</b> (en modo hexa), esto despierta la memoria</li>\n<li>Deberíamos recibir una contestación <b>FF</b></li>\n<li>Desmarcamos <b>RTS</b>, el LED1 se enciende</li>\n<li>Tildamos <b>RTS</b>, el LED1 se apaga</li>\n<li>Enviamos <b>9F 00 00 00</b> (en modo hexa)</li>\n<li>Deberíamos recibir una contestación <b>FF EF 30 13</b>, este es el ID de la memoria</li>\n<li>Desmarcamos <b>RTS</b>, el LED1 se enciende</li>\n</ol>\n",
            "readonly": true
          },
          "position": {
            "x": 960,
        ...
        {
          "id": "6d78143a-71bd-42ba-afcb-dbc3a6b0d45f",
          "type": "basic.info",
          "data": {
            "info": "Este LED cambia cada\nvez que se hace una\ntransmisión",
            "readonly": true
          },
          "position": {
            "x": 1296,
        ...
        {
          "id": "e0feadfe-7b53-4656-a789-85c8c34ad382",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "922538fb-9c32-41c5-aa6a-0197c2b2216e",
          "type": "basic.info",
          "data": {
            "info": "Este LED se apaga \ncuando la memoria\nestá seleccionada.",
            "readonly": true
          },
          "position": {
            "x": 720,
        ...
        {
          "id": "e0bbea5a-fadd-4527-9e58-c4a515d944b4",
          "type": "basic.info",
          "data": {
            "info": "Si la PC configura\nRTS a 1 esta señal\npasa a 0 y la memoria\nqueda seleccionada.",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "df91867c-36ec-4069-9eb7-887f528275ff",
            "port": "input-RX"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "30107466-73bf-4bdc-9da8-03b08e90e6bc",
            "port": "input-tx"
          },
          "size": 8
        },
        ...
        {
          "source": {
            "block": "834fd173-3dda-466e-b5e2-246259da8453",
            "port": "output-1"
          },
          "target": {
            "block": "30107466-73bf-4bdc-9da8-03b08e90e6bc",
        ...
        {
          "source": {
            "block": "c02ed5dc-09ca-470d-b4d8-50e5bf670ab8",
            "port": "output-1"
          },
          "target": {
            "block": "30107466-73bf-4bdc-9da8-03b08e90e6bc",
        ...
        {
          "source": {
            "block": "4111374b-f128-49cd-a08e-f0c37aa7c3d1",
            "port": "output-TX"
          },
          "target": {
            "block": "output-Tx",
        ...
        },
        {
          ...
          "target": {
            "block": "90edfc06-021a-4b33-b636-366184e94d2e",
            "port": "input-t"
          }
        },
        {
        ...
        {
          "source": {
            "block": "40f3849a-cc70-4a3b-8387-49f27a7a3b9d",
            "port": "output-q"
          },
          "target": {
            "block": "output-LED3",
        ...
        {
          "source": {
            "block": "1f95c4cb-e4d6-434c-9a0f-5ccc3742e3d7",
            "port": "output-q"
          },
          "target": {
            "block": "40f3849a-cc70-4a3b-8387-49f27a7a3b9d",
...
,"size": 8
  ...
  "design": {
    ...
    "0c047e376a948cb9d8ae3766115c9627fe5819ce": {
  "package": {
...
,"size": 8
    ...
    "c49282f2f18dab416a414d2d04c917f6935188aa": {
  "package": {
...
,"size": 8
        ...
        },
        {
          ...
          "type": "94e4a74a24c131fadcb747305aa55879234061fc",
          "position": {
            "x": 392,
            "y": 176
          },
    ...
    "94e4a74a24c131fadcb747305aa55879234061fc": {
  "package": {
...
,"size": 8
        ...
        },
        {
          ...
          "type": "685dba687d33a8af91fec6a6d1204c49305b1f28",
          "position": {
            "x": 576,
            "y": 296
          },
    ...
    "685dba687d33a8af91fec6a6d1204c49305b1f28": {
  "package": {
    "name": "Transmisor Serie base",
    "version": "1.0.0",
    "description": "Transmisor serie sin generador de baudate",
...
,"size": 10
  ...
  "design": {
    ...
    "9ba1be66568ffe4d9ccac0781a247ca51ed4fff6": {
  "package": {
    "name": "Detecta Subida",
    "version": "1.0.0",
